...
def train_GAN(filenames: IFilenames,
    ...
    try:
        ...
        for epoch in tqdm(range(epochs)):
            ...
            helpers.change_optim_lr(disc_optim, global_step, [50, 100], [15e-5, 1e-4])
...
# [MAIN PROGRAM] -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
def main():
    # tensorboard --samples_per_plugin "images=1000,scalars=5000" --logdir="./Prototypes/models state_dict/CDCGAN_Animal_Faces_v6/tensorboard"
    os.system("cls")
