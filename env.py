...
env: ENVInterface = {
    # Name of the dir where all datasets are stored, used in helpers.py
    ...
    # Name of the dir where state_dicts are saved, used in helpers.py
    "MODELS_STATE_DICT_DIR": "models state_dict",
    
    # Name of the dir where tensorboard saves/reads data, used in helpers.py
